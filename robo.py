...
class Sistema:
    ...
    def login(self,tipo):
        ...
        if(self.usuario == '' or self.senha == '' ):
            ...
            sg.Print("Login efetuado com sucesso!")
    ...
    def receber(self):
        ...
        for i in range(1,10):
            ...
            sg.Print(f'{timestamp} Termo 1200 recebido')                
    ...
    def incorporar(self, origem, ntermo, descricao, patrimonios):
        ...
        resultado = self.navegador.find_element(By.XPATH, '/html/body/div/div[1]/table/tbody/tr/td[3]/div/div[1]/table/tbody/tr/td/span[2]')
        sleep(5)
