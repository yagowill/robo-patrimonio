...
origem = 'SEGUP - SECRETARIA DE ESTADO DE SEGURANÇA PÚBLICA E DEFESA SOCIAL'
ntermo = '2023/1008'
...
sleep(1.5)
while True:
    planilha = open('incorporados_segup.csv', 'a')
    sleep(1.5)
    ...
    descricao = WebDriverWait(driver, timeout=60)\
    .until(EC.presence_of_element_located((By.XPATH, '/html/body/div/div[1]/table/tbody/tr/td[3]/div/form[2]/span/table/tbody/tr[1]/td[3]'))).text
    
    driver.execute_script("arguments[0].click();", selecionar_ben_btn)
    sleep(.5)

    rp = WebDriverWait(driver, timeout=60)\
    .until(EC.presence_of_element_located((By.XPATH, '/html/body/div/div[1]/table/tbody/tr/td[3]/div/form/div/div/table[2]/tbody/tr[1]/td[2]/span'))).text
